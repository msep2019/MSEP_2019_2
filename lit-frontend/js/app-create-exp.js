App = {
  ...
  initWeb3: async function() {
    ...
    */
    ...
    // This is only for development. It is insecure for production.
      ...
      // FIXME
      // Move the location code outside
  ...
  getTextArea: function(_textName) {
    selector = "textarea[name='"+ _textName + "']";
    var radios = $(selector);
    var textValue = $(selector).val();
    return textValue;
  },
  ...
  handleSubmit : function(event) {
    ...
    // });
    [expName, expHomepage, expArtifact] = ["_name", "_homepage", "_artifact" ].map((item) => {      
      return App.getTextInput(item);
    });
